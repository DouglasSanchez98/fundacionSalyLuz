...
const ContactRamos = () => {
    return (
        <div name="contacto"
            className="w-full h-screen bg-green-one p-4 text-white">
 ...
 bg-gradient-to-b from-orange-one to-white px-6 py-3 mt-3 mx-auto flex items-center rounded-md hover:sacale-110 duratión-300">
                            Enviar
                        </button>
                    </form>
                </div>
